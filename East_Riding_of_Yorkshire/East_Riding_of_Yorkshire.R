...
## TO CHANGE ##
Council_name <- "East_Riding_of_Yorkshire" # String
WD <- "U:/Councils/East_Riding_of_Yorkshire" # String
setwd(WD)
...
Cols <- c("^Trans\\.Date$", "^Vendor\\.Name$", "^Net\\.Amount$", "^Directorate$",
          "^beneficiary\\.name$", "service")
