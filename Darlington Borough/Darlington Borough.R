...
## TO CHANGE ##
Council_name <- "Darlington_Borough" # String
WD <- "U:/Councils/Darlington Borough" # String
...
Subset_CSV_URLs <- c(seq(178, (178+(12*2)), 2)) # Numbers - CHANGE
...
# Append start of URL:
URL_start <- "http://www.darlington.gov.uk"
for (i in 1:length(Data)){
...
Skip_Number_of_Lines <-  5 # One Number - CHANGE
if (Skip == 1){
...
Cols <- c("Service", "Supplier", "Invoice.Line.Value..net.of.VAT.", "Account")
...
List_members_reorder <- c(1:3) # Numbers - CHANGE
Cols_reorder <- c(4, 1, 2, 3) # Numbers - new order of columns - CHANGE
