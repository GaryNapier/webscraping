...
## TO CHANGE ##
Council_name <- "Thurrock_Council" # String
WD <- "U:/Councils/Thurrock Council" # String
URL <- "https://www.thurrock.gov.uk/what-we-spend/payments-to-suppliers" # String
...
Subset_CSV_URLs <- c(19:25, 38:41) # Numbers - CHANGE
...
Cols <- c("Date", "Department", "Beneficiary", "Merchant.Category", "SumOfAmounts", "Amounts")
